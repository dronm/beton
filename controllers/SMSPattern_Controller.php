	...
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$pm->addParam($param);
			...
			$f_params = array();
				...
				$param = new FieldExtEnum('sms_type',',','order,ship,remind,procur,order_for_pump_ins,order_for_pump_upd,order_for_pump_del,remind_for_pump,client_thank,vehicle_zone_violation,vehicle_tracker_malfunction,efficiency_warn,material_balance,mixer_route,order_cancel,tm_invite,new_pwd'
				,$f_params);
		$pm->addParam($param);
