...
class OrderGarbage_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$pm->addEvent('OrderGarbage.delete',$ev_opts);
		
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('OrderGarbage_Model');
		...
		$this->setListModelId('OrderGarbageList_Model');
		...
		$pm->addParam(new FieldExtString('lsn'));
		$this->addPublicMethod($pm);
		$this->setObjectModelId('OrderGarbageDialog_Model');		
