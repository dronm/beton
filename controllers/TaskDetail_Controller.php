...
class TaskDetail_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$pm = new PublicMethod('insert');
			...
			$f_params = array();
				...
				$f_params['alias']='Шапка задачи';
			$param = new FieldExtInt('task_id'
				,$f_params);
		$pm->addParam($param);
		
			$f_params = array();
			
				$f_params['alias']='Сотрудник';
		...
		$pm->addEvent('TaskDetail.insert',$ev_opts);
		
		$this->addPublicMethod($pm);
		$this->setInsertModelId('TaskDetail_Model');
		...
		$pm->addParam(new FieldExtInt('obj_mode'));
			...
			$pm->addEvent('TaskDetail.update',$ev_opts);
			
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('TaskDetail_Model');
		...
		$pm->addEvent('TaskDetail.delete',$ev_opts);
		
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('TaskDetail_Model');
		...
		$this->setListModelId('TaskDetail_Model');
		...
		$pm->addParam(new FieldExtString('lsn'));
		$this->addPublicMethod($pm);
		$this->setObjectModelId('TaskDetail_Model');		
