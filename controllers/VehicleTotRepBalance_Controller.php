...
class VehicleTotRepBalance_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$pm->addEvent('VehicleTotRepBalance.insert',$ev_opts);
		
		$this->addPublicMethod($pm);
		$this->setInsertModelId('VehicleTotRepBalance_Model');
		...
		$pm->addParam(new FieldExtInt('obj_mode'));
			...
			$pm->addEvent('VehicleTotRepBalance.update',$ev_opts);
			
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('VehicleTotRepBalance_Model');
		...
		$pm->addEvent('VehicleTotRepBalance.delete',$ev_opts);
		
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('VehicleTotRepBalance_Model');
		...
		$this->setListModelId('VehicleTotRepBalanceList_Model');
		...
		$pm->addParam(new FieldExtString('lsn'));
		$this->addPublicMethod($pm);
		$this->setObjectModelId('VehicleTotRepBalanceList_Model');		
