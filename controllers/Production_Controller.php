...
class Production_Controller extends ControllerSQL{
	...
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$pm = new PublicMethod('insert');
			...
			$f_params = array();
				...
				$f_params['alias']='Elkon production ID';
		...
		$pm->addParam($param);
			...
			$f_params = array();
				...
				$f_params['alias']='Начало производства в Elkon';
		...
		$pm->addParam($param);
			...
			$f_params = array();
				...
				$f_params['alias']='Окончание производства в Elkon';
		...
		$pm->addParam($param);
			...
			$f_params = array();
				...
				$f_params['alias']='Пользователь Elkon';
		...
		$pm->addParam($param);
			...
			$f_params = array();
				...
				$f_params['alias']='Ручное исправление';
	...
	$opts=array();
		...
		$pm = new PublicMethod('get_ship_prod_quant_dif');
