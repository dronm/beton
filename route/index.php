...
$htmp_cont = str_replace('{{appSrvPort}}', (isset($_SERVER['HTTPS'])&&defined('APP_SERVER_PORT_SECURED'))? APP_SERVER_PORT_SECURED:APP_SERVER_PORT, $htmp_cont);
...
$htmp_cont = str_replace('{{is_client}}', $is_client? 'true':'false', $htmp_cont);
