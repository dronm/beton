...
<xsl:variable name="TOKEN">
	<xsl:choose>
		<xsl:when test="/document/model[@id='ServerVars']/row[1]/token and not(/document/model[@id='ServerVars']/row[1]/token='')"><xsl:value-of select="/document/model[@id='ServerVars']/row[1]/token"/></xsl:when>
...
<xsl:template name="initApp">
	...
	<xsl:if test="not(/document/model[@id='ServerVars']/row/role_id='guest')">	
	<!-- "protocol":'<xsl:value-of select="/document/model[@id='ServerVars']/row[1]/app_srv_protocol"/>' -->
	//event server
	application.initAppSrv({		
		"host":'<xsl:value-of select="/document/model[@id='ServerVars']/row[1]/app_srv_host"/>'
		,"port":'<xsl:value-of select="/document/model[@id='ServerVars']/row[1]/app_srv_port"/>'
...
<xsl:template name="initMenu">
	<xsl:if test="model[@id='MainMenu_Model'] or /document/model[@id='ServerVars']/row/role_id='owner'">
	<!-- Main navigation -->
	<ul class="nav navbar-nav">
		...
		<xsl:if test="/document/model[@id='ServerVars']/row/role_id='owner'">
		<!-- service -->
		<li class="dropdown">
...
<xsl:template name="checkForError">
	...
	<xsl:when test="not($er_num='0') and not(/document/model[@id='ServerVars']/row/role_id='guest')">		
...
<xsl:template name="page_header">
	...
	<div class="container-fluid">
		...
		<xsl:choose>
		<xsl:when test="/document/model[@id='ServerVars']/row/role_id='guest'">
