...
class ViewBase extends ViewHTMLXSLT {	
	...
	*/
	...
	public function __construct($name){
		...
		if (!DEBUG){
			$this->addJsModel(new ModelJavaScript('js20/assets/js/core/libraries/jquery.min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/assets/js/core/libraries/jquery.min.js')) ));$this->addJsModel(new ModelJavaScript('js20/assets/js/core/libraries/bootstrap.min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/assets/js/core/libraries/bootstrap.min.js')) ));$this->addJsModel(new ModelJavaScript('js20/assets/js/plugins/loaders/blockui.min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/assets/js/plugins/loaders/blockui.min.js')) ));$this->addJsModel(new ModelJavaScript('js20/assets/js/core/app.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/assets/js/core/app.js')) ));$this->addJsModel(new ModelJavaScript('js20/ext/bootstrap-datepicker/bootstrap-datepicker.min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/ext/bootstrap-datepicker/bootstrap-datepicker.min.js')) ));$this->addJsModel(new ModelJavaScript('js20/ext/bootstrap-datepicker/bootstrap-datepicker.ru.min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/ext/bootstrap-datepicker/bootstrap-datepicker.ru.min.js')) ));$this->addJsModel(new ModelJavaScript('js20/ext/cleave/cleave.min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/ext/cleave/cleave.min.js')) ));$this->addJsModel(new ModelJavaScript('js20/ext/cleave/cleave-phone.ru.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/ext/cleave/cleave-phone.ru.js')) ));$this->addJsModel(new ModelJavaScript('js20/ext/mustache/mustache.min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/ext/mustache/mustache.min.js')) ));$this->addJsModel(new ModelJavaScript('js20/ext/jshash-2.2/md5-min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/ext/jshash-2.2/md5-min.js')) ));$this->addJsModel(new ModelJavaScript('js20/ext/OpenLayers/OpenLayers.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/ext/OpenLayers/OpenLayers.js')) ));$this->addJsModel(new ModelJavaScript('js20/ext/chart.js-2.8.0/Chart.min.js', NULL, date("Y-m-dTH:i:s", filemtime('js20/ext/chart.js-2.8.0/Chart.min.js')) ));
