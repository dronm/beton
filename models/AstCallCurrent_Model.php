...
class AstCallCurrent_Model extends ModelSQLBeton{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("ast_calls_current");
		...
		//*** Field contact_email ***
		$f_opts = array();
		$f_opts['id']="contact_email";
						
		$f_contact_email=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"contact_email",$f_opts);
		$this->addField($f_contact_email);
		//********************
		
		//*** Field contact_post_name ***
		$f_opts = array();
		$f_opts['id']="contact_post_name";
						
		$f_contact_post_name=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"contact_post_name",$f_opts);
		$this->addField($f_contact_post_name);
		//********************
