...
class QualityPassportList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("quality_passports_list");
		...
		$f_krupnost=new FieldSQLInt($this->getDbLink(),$this->getDbName(),$this->getTableName(),"krupnost",$f_opts);
		...
		//*** Field shipments_list ***
		$f_opts = array();
		$f_opts['id']="shipments_list";
						
		$f_shipments_list=new FieldSQLJSON($this->getDbLink(),$this->getDbName(),$this->getTableName(),"shipments_list",$f_opts);
		$this->addField($f_shipments_list);
		//********************
	
		$order = new ModelOrderSQL();		
		$this->setDefaultModelOrder($order);		
		$direct = 'DESC';
		$order->addField($f_vidan,$direct);
