...
class OrderForBuhList_Model extends ModelSQLBeton{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("orders_for_buh_list");
		...
		//*** Field buh_doc_ref_1c ***
		$f_opts = array();
		
		$f_opts['alias']='Накладная 1с';
		$f_opts['id']="buh_doc_ref_1c";
						
		$f_buh_doc_ref_1c=new FieldSQLJSON($this->getDbLink(),$this->getDbName(),$this->getTableName(),"buh_doc_ref_1c",$f_opts);
		$this->addField($f_buh_doc_ref_1c);
		//********************
