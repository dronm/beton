...
class UserChatUserList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("user_chat_user_list");
		...
		//*** Field unviewed_msg_cnt ***
		$f_opts = array();
		
		$f_opts['alias']='Непрочитанные сообщения';
		$f_opts['id']="unviewed_msg_cnt";
						
		$f_unviewed_msg_cnt=new FieldSQLInt($this->getDbLink(),$this->getDbName(),$this->getTableName(),"unviewed_msg_cnt",$f_opts);
		$this->addField($f_unviewed_msg_cnt);
		//********************
