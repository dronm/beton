...
class VehicleTotRepItemValue_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("vehicle_tot_rep_item_vals");
		...
		//*** Field vehicle_tot_rep_item_id ***
		$f_opts = array();
		$f_opts['primaryKey'] = TRUE;
		$f_opts['autoInc']=FALSE;
		$f_opts['id']="vehicle_tot_rep_item_id";
						
		$f_vehicle_tot_rep_item_id=new FieldSQLInt($this->getDbLink(),$this->getDbName(),$this->getTableName(),"vehicle_tot_rep_item_id",$f_opts);
		$this->addField($f_vehicle_tot_rep_item_id);
		//********************
