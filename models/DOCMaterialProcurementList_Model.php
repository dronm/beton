...
class DOCMaterialProcurementList_Model extends ModelSQLDOC{
	...
	$this->setAggFunctions(
		array(array('alias'=>'total_quant_net','expr'=>'sum(quant_net)')
,array('alias'=>'total_doc_quant_net','expr'=>'sum(doc_quant_net)')
,array('alias'=>'total_quant_gross','expr'=>'sum(quant_gross)')
)
	);	
