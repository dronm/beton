...
class UserChatHistory_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("user_chat_history");
		...
		$f_tp=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"tp",$f_opts);
		$this->addField($f_tp);
		//********************
		...
		$f_text=new FieldSQLText($this->getDbLink(),$this->getDbName(),$this->getTableName(),"text",$f_opts);
		$this->addField($f_text);
		//********************
