...
class TmUserPhotoList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("ext_users_photo_list");
		...
		//*** Field ext_contacts_ref ***
		$f_opts = array();
		$f_opts['id']="ext_contacts_ref";
						
		$f_ext_contacts_ref=new FieldSQLJSON($this->getDbLink(),$this->getDbName(),$this->getTableName(),"ext_contacts_ref",$f_opts);
		$this->addField($f_ext_contacts_ref);
		//********************
		
		//*** Field ext_contacts_tel ***
		$f_opts = array();
		$f_opts['id']="ext_contacts_tel";
						
		$f_ext_contacts_tel=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"ext_contacts_tel",$f_opts);
		$this->addField($f_ext_contacts_tel);
		//********************
