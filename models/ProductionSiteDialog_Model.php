...
class ProductionSiteDialog_Model extends ModelSQLBeton{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("production_sites_dialog");
		...
		//*** Field dispatchers_ref ***
		$f_opts = array();
		
		$f_opts['alias']='Диспетчер (ТТН)';
		$f_opts['id']="dispatchers_ref";
						
		$f_dispatchers_ref=new FieldSQLJSONB($this->getDbLink(),$this->getDbName(),$this->getTableName(),"dispatchers_ref",$f_opts);
		$this->addField($f_dispatchers_ref);
		//********************
