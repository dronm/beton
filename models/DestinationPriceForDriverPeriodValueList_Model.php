...
class DestinationPriceForDriverPeriodValueList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("destinaion_price_for_driver_period_value_list");
		...
		$f_val=new FieldSQLFloat($this->getDbLink(),$this->getDbName(),$this->getTableName(),"val",$f_opts);
		$this->addField($f_val);
		//********************
