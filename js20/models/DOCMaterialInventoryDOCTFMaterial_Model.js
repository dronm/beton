...
function DOCMaterialInventoryDOCTFMaterial_Model(options){
	var id = 'DOCMaterialInventoryDOCTFMaterial_Model';
	options = options || {};
	...
	options.fields.quant.getValidator().setMaxLength('19');
		...
		DOCMaterialInventoryDOCTFMaterial_Model.superclass.constructor.call(this,id,options);
}
