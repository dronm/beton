...
function ConcreteCostForOwnerHeader_Model(options){
	var id = 'ConcreteCostForOwnerHeader_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		ConcreteCostForOwnerHeader_Model.superclass.constructor.call(this,id,options);
}
