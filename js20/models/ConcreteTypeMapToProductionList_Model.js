...
function ConcreteTypeMapToProductionList_Model(options){
	var id = 'ConcreteTypeMapToProductionList_Model';
	options = options || {};
	...
	options.fields.production_descr.getValidator().setMaxLength('100');
		...
		ConcreteTypeMapToProductionList_Model.superclass.constructor.call(this,id,options);
}
