...
function ClientSpecificationFlow_Model(options){
	var id = 'ClientSpecificationFlow_Model';
	options = options || {};
	...
	options.fields.quant.getValidator().setMaxLength('19');
		...
		ClientSpecificationFlow_Model.superclass.constructor.call(this,id,options);
}
