...
function ExcelTemplateImageSQL_Model(options){
	var id = 'ExcelTemplateImageSQL_Model';
	options = options || {};
	...
	options.fields.sql_query = new FieldString("sql_query",filed_options);
	options.fields.sql_query.getValidator().setMaxLength('5000');
	...
	options.fields.comment_text.getValidator().setMaxLength('5000');
		...
		ExcelTemplateImageSQL_Model.superclass.constructor.call(this,id,options);
}
