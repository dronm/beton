...
function RAFuelFlow_Model(options){
	var id = 'RAFuelFlow_Model';
	options = options || {};
	...
	filed_options.enumValues = 'order,material_procurement,shipment,material_fact_consumption,material_fact_consumption_correction,material_fact_balance_correction,cement_silo_reset,cement_silo_balance_reset,material_movement';
	...
	options.fields.quant = new FieldInt("quant",filed_options);
		...
		RAFuelFlow_Model.superclass.constructor.call(this,id,options);
}
extend(RAFuelFlow_Model,ModelXML);
