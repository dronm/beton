...
function ConcreteTypeMapToProduction_Model(options){
	var id = 'ConcreteTypeMapToProduction_Model';
	options = options || {};
	...
	options.fields.production_descr.getValidator().setMaxLength('100');
		...
		ConcreteTypeMapToProduction_Model.superclass.constructor.call(this,id,options);
}
