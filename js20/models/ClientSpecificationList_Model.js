...
function ClientSpecificationList_Model(options){
	var id = 'ClientSpecificationList_Model';
	options = options || {};
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Договор';
	filed_options.autoInc = false;	
	
	options.fields.contract = new FieldText("contract",filed_options);
	...
	options.fields.specification = new FieldText("specification",filed_options);
	...
	options.fields.quant_balance = new FieldInt("quant_balance",filed_options);
	...
	options.fields.total.getValidator().setMaxLength('15');
		...
		ClientSpecificationList_Model.superclass.constructor.call(this,id,options);
}
