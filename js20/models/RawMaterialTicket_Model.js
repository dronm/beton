...
function RawMaterialTicket_Model(options){
	var id = 'RawMaterialTicket_Model';
	options = options || {};
	...
	options.fields.barcode.getValidator().setMaxLength('13');
	...
	options.fields.expire_date = new FieldDate("expire_date",filed_options);
		...
		RawMaterialTicket_Model.superclass.constructor.call(this,id,options);
}
