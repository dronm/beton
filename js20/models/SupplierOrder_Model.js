...
function SupplierOrder_Model(options){
	var id = 'SupplierOrder_Model';
	options = options || {};
	...
	options.fields.vehicles = new FieldInt("vehicles",filed_options);
	...
	options.fields.sms_confirmed = new FieldBool("sms_confirmed",filed_options);
	
		SupplierOrder_Model.superclass.constructor.call(this,id,options);
}
