...
function ELKONLogList_Model(options){
	var id = 'ELKONLogList_Model';
	options = options || {};
	...
	options.fields.level = new FieldInt("level",filed_options);
	...
	options.fields.production_site_id = new FieldInt("production_site_id",filed_options);
		...
		ELKONLogList_Model.superclass.constructor.call(this,id,options);
}
