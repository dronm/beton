...
function OrderDialog_Model(options){
	var id = 'OrderDialog_Model';
	options = options || {};
	...
	options.fields.destination_distance = new FieldFloat("destination_distance",filed_options);
	...
	options.fields.time_to = new FieldTime("time_to",filed_options);
	...
	options.fields.pump_vehicle_phone_cel = new FieldString("pump_vehicle_phone_cel",filed_options);
	...
	options.fields.tm_id = new FieldInt("tm_id",filed_options);
	...
	options.fields.client_specifications_ref = new FieldJSON("client_specifications_ref",filed_options);
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Взаиморасчеты';
	filed_options.autoInc = false;	
