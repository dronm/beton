...
function EmployeeWorkTimeSchedule_Model(options){
	var id = 'EmployeeWorkTimeSchedule_Model';
	options = options || {};
	...
	options.fields.day.getValidator().setRequired(true);
	...
	options.fields.hours.getValidator().setRequired(true);
	
			
			
		EmployeeWorkTimeSchedule_Model.superclass.constructor.call(this,id,options);
}
