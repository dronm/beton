...
function VehicleTotRepBalanceList_Model(options){
	var id = 'VehicleTotRepBalanceList_Model';
	options = options || {};
	...
	filed_options.alias = 'Собственник';
	filed_options.autoInc = false;	
	...
	options.fields.value.getValidator().setMaxLength('15');
		...
		VehicleTotRepBalanceList_Model.superclass.constructor.call(this,id,options);
}
