...
function RawMaterialStoreUserDataList_Model(options){
	var id = 'RawMaterialStoreUserDataList_Model';
	options = options || {};
	...
	options.fields.quant.getValidator().setMaxLength('15');
		...
		RawMaterialStoreUserDataList_Model.superclass.constructor.call(this,id,options);
}
