...
function ClientSpecificationFlowList_Model(options){
	var id = 'ClientSpecificationFlowList_Model';
	options = options || {};
	...
	options.fields.quant.getValidator().setMaxLength('19');
		...
		ClientSpecificationFlowList_Model.superclass.constructor.call(this,id,options);
}
