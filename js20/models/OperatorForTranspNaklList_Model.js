...
function OperatorForTranspNaklList_Model(options){
	var id = 'OperatorForTranspNaklList_Model';
	options = options || {};
	...
	options.fields.users_ref = new FieldJSON("users_ref",filed_options);
		...
		OperatorForTranspNaklList_Model.superclass.constructor.call(this,id,options);
}
