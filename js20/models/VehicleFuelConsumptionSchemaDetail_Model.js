...
function VehicleFuelConsumptionSchemaDetail_Model(options){
	var id = 'VehicleFuelConsumptionSchemaDetail_Model';
	options = options || {};
	...
	options.fields.quant_time.getValidator().setMaxLength('15');
		...
		VehicleFuelConsumptionSchemaDetail_Model.superclass.constructor.call(this,id,options);
}
extend(VehicleFuelConsumptionSchemaDetail_Model,ModelXML);
