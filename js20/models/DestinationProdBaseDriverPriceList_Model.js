...
function DestinationProdBaseDriverPriceList_Model(options){
	var id = 'DestinationProdBaseDriverPriceList_Model';
	options = options || {};
	...
	options.fields.price.getValidator().setMaxLength('15');
		...
		DestinationProdBaseDriverPriceList_Model.superclass.constructor.call(this,id,options);
}
