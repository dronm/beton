...
function DestinationProdBasePriceList_Model(options){
	var id = 'DestinationProdBasePriceList_Model';
	options = options || {};
	...
	options.fields.price.getValidator().setMaxLength('15');
		...
		DestinationProdBasePriceList_Model.superclass.constructor.call(this,id,options);
}
