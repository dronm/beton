...
function ShipmentForDriverCostHeader_Model(options){
	var id = 'ShipmentForDriverCostHeader_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		ShipmentForDriverCostHeader_Model.superclass.constructor.call(this,id,options);
}
