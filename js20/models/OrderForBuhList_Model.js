...
function OrderForBuhList_Model(options){
	var id = 'OrderForBuhList_Model';
	options = options || {};
	...
	options.fields.buh_doc_ref_1c = new FieldJSON("buh_doc_ref_1c",filed_options);
		...
		OrderForBuhList_Model.superclass.constructor.call(this,id,options);
}
extend(OrderForBuhList_Model,ModelXML);
