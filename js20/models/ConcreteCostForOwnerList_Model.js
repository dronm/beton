...
function ConcreteCostForOwnerList_Model(options){
	var id = 'ConcreteCostForOwnerList_Model';
	options = options || {};
	...
	options.fields.price.getValidator().setMaxLength('15');
		...
		ConcreteCostForOwnerList_Model.superclass.constructor.call(this,id,options);
}
