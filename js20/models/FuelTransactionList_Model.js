...
function FuelTransactionList_Model(options){
	var id = 'FuelTransactionList_Model';
	options = options || {};
	...
	options.fields.id = new FieldText("id",filed_options);
	...
	options.fields.card_id = new FieldText("card_id",filed_options);
	options.fields.card_id.getValidator().setRequired(true);
	...
	options.fields.attrs = new FieldJSON("attrs",filed_options);
	...
	options.fields.total.getValidator().setMaxLength('15');
		...
		FuelTransactionList_Model.superclass.constructor.call(this,id,options);
}
extend(FuelTransactionList_Model,ModelXML);
