...
function DestinationProdBaseDriverPrice_Model(options){
	var id = 'DestinationProdBaseDriverPrice_Model';
	options = options || {};
	...
	options.fields.price.getValidator().setMaxLength('15');
		...
		DestinationProdBaseDriverPrice_Model.superclass.constructor.call(this,id,options);
}
