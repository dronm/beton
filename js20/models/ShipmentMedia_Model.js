...
function ShipmentMedia_Model(options){
	var id = 'ShipmentMedia_Model';
	options = options || {};
	...
	options.fields.message_id = new FieldInt("message_id",filed_options);
	
			
		ShipmentMedia_Model.superclass.constructor.call(this,id,options);
}
