...
function GornyiCarrierMatchList_Model(options){
	var id = 'GornyiCarrierMatchList_Model';
	options = options || {};
	...
	options.fields.plate.getValidator().setMaxLength('8');
	
		GornyiCarrierMatchList_Model.superclass.constructor.call(this,id,options);
}
