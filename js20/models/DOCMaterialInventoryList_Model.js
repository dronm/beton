...
function DOCMaterialInventoryList_Model(options){
	var id = 'DOCMaterialInventoryList_Model';
	options = options || {};
	...
	options.fields.processed = new FieldString("processed",filed_options);
		...
		DOCMaterialInventoryList_Model.superclass.constructor.call(this,id,options);
}
