...
function ShipmentForOwnerCostHeader_Model(options){
	var id = 'ShipmentForOwnerCostHeader_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		ShipmentForOwnerCostHeader_Model.superclass.constructor.call(this,id,options);
}
