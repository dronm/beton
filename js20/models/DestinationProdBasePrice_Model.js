...
function DestinationProdBasePrice_Model(options){
	var id = 'DestinationProdBasePrice_Model';
	options = options || {};
	...
	options.fields.price.getValidator().setMaxLength('15');
		...
		DestinationProdBasePrice_Model.superclass.constructor.call(this,id,options);
}
