...
function VehicleOwnerHistoryList_Model(options){
	var id = 'VehicleOwnerHistoryList_Model';
	options = options || {};
	...
	options.fields.date_from = new FieldDateTime("date_from",filed_options);
	
		VehicleOwnerHistoryList_Model.superclass.constructor.call(this,id,options);
}
