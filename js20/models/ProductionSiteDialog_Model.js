...
function ProductionSiteDialog_Model(options){
	var id = 'ProductionSiteDialog_Model';
	options = options || {};
	...
	options.fields.dispatchers_ref = new FieldJSONB("dispatchers_ref",filed_options);
	...
	options.fields.ref_1c = new FieldJSONB("ref_1c",filed_options);
		...
		ProductionSiteDialog_Model.superclass.constructor.call(this,id,options);
}
extend(ProductionSiteDialog_Model,ModelXML);
