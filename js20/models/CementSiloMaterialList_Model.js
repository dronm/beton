...
function CementSiloMaterialList_Model(options){
	var id = 'CementSiloMaterialList_Model';
	options = options || {};
	...
	options.fields.date_time = new FieldDateTimeTZ("date_time",filed_options);
		...
		CementSiloMaterialList_Model.superclass.constructor.call(this,id,options);
}
