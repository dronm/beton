...
function RawMaterialProcurUploadView_Model(options){
	var id = 'RawMaterialProcurUploadView_Model';
	options = options || {};
	...
	options.fields.doc_count = new FieldInt("doc_count",filed_options);
		...
		RawMaterialProcurUploadView_Model.superclass.constructor.call(this,id,options);
}
