...
function ConcreteCostForOwner_Model(options){
	var id = 'ConcreteCostForOwner_Model';
	options = options || {};
	...
	options.fields.header_id = new FieldInt("header_id",filed_options);
	options.fields.header_id.getValidator().setRequired(true);
