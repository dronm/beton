...
function ClientTelList_Model(options){
	var id = 'ClientTelList_Model';
	options = options || {};
	...
	options.fields.search = new FieldString("search",filed_options);
	...
	options.fields.tm_activated = new FieldBool("tm_activated",filed_options);
		...
		ClientTelList_Model.superclass.constructor.call(this,id,options);
}
