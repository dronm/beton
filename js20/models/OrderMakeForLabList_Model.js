...
function OrderMakeForLabList_Model(options){
	var id = 'OrderMakeForLabList_Model';
	options = options || {};
	...
	options.fields.date_time_to = new FieldTime("date_time_to",filed_options);
	...
	options.fields.quant_rest = new FieldFloat("quant_rest",filed_options);
	...
	options.fields.quant_ordered_before_now = new FieldFloat("quant_ordered_before_now",filed_options);
	...
	options.fields.quant_shipped_before_now = new FieldFloat("quant_shipped_before_now",filed_options);
	...
	options.fields.quant_shipped_day_before_now = new FieldFloat("quant_shipped_day_before_now",filed_options);
	...
	options.fields.quant_ordered_day = new FieldFloat("quant_ordered_day",filed_options);
	...
	options.fields.is_needed = new FieldBool("is_needed",filed_options);
	
		OrderMakeForLabList_Model.superclass.constructor.call(this,id,options);
}
