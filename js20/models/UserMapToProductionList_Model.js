...
function UserMapToProductionList_Model(options){
	var id = 'UserMapToProductionList_Model';
	options = options || {};
	...
	options.fields.production_descr = new FieldString("production_descr",filed_options);
		...
		UserMapToProductionList_Model.superclass.constructor.call(this,id,options);
}
