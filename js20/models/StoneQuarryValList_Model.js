...
function StoneQuarryValList_Model(options){
	var id = 'StoneQuarryValList_Model';
	options = options || {};
	...
	options.fields.quarry_descr = new FieldString("quarry_descr",filed_options);
	...
	options.fields.v_comment = new FieldText("v_comment",filed_options);
		...
		StoneQuarryValList_Model.superclass.constructor.call(this,id,options);
}
