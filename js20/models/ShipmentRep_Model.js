...
function ShipmentRep_Model(options){
	var id = 'ShipmentRep_Model';
	options = options || {};
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Смена';
	filed_options.autoInc = false;	
	
	options.fields.shift_descr = new FieldDate("shift_descr",filed_options);
	...
	options.fields.concrete_id = new FieldInt("concrete_id",filed_options);
	...
	options.fields.concrete_descr = new FieldString("concrete_descr",filed_options);
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Свойство автом.';
	filed_options.autoInc = false;	
	
	options.fields.vehicle_feature = new FieldString("vehicle_feature",filed_options);
	
				
	
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Владелец автом.';
	filed_options.autoInc = false;	
	
	options.fields.vehicle_owner = new FieldString("vehicle_owner",filed_options);
	...
	options.fields.quant_shipped = new FieldFloat("quant_shipped",filed_options);
		...
		ShipmentRep_Model.superclass.constructor.call(this,id,options);
}
