 ...
 */	
function LabEntryItemReport_View(id,options){

	options = options || {};
	
	var contr = new LabEntry_Controller();	
	options.publicMethod = contr.getPublicMethod("item_report");
	...
	LabEntryItemReport_View.superclass.constructor.call(this, id, options);
