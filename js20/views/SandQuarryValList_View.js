 ...
 */
function SandQuarryValList_View(id,options){	

	SandQuarryValList_View.superclass.constructor.call(this,id,options);

	var model = options.models.SandQuarryValList_Model;
	var contr = new SandQuarryVal_Controller();
			...
			"elements":[
				new GridRow(id+":grid:head:row0",{
					"elements":[
						...
						,new GridCellHead(id+":grid:head:v_0_05",{
							"value":"0,05",
							"columns":[
								new GridColumnFloat({
									"field":model.getField("v_0_05"),
									"ctrlClass":EditFloat
								})
							]
						})												
						,new GridCellHead(id+":grid:head:v_0_16",{
							"value":"0,16",
							"columns":[
								new GridColumnFloat({
									"field":model.getField("v_0_16"),
									"ctrlClass":EditFloat
								})
							]
						})												
						,new GridCellHead(id+":grid:head:v_0_63",{
							"value":"0,63",
							"columns":[
								new GridColumnFloat({
									"field":model.getField("v_0_63"),
									"ctrlClass":EditFloat
								})
							]
						})												
						,new GridCellHead(id+":grid:head:v_1_25",{
							"value":"1,25",
							"columns":[
								new GridColumnFloat({
									"field":model.getField("v_1_25"),
									"ctrlClass":EditFloat
								})
							]
						})												
						
						,new GridCellHead(id+":grid:head:v_2_5",{
							"value":"2,5",
							"columns":[
								new GridColumnFloat({
									"field":model.getField("v_2_5"),
									"ctrlClass":EditFloat
								})
							]
						})												
						,new GridCellHead(id+":grid:head:v_mkr",{
							"value":"мкр",
							"columns":[
								new GridColumnFloat({
									"field":model.getField("v_mkr"),
									"ctrlClass":EditFloat
								})
							]
						})												
