 ...
 */
function ShipmentForButList_View(id,options){	

	options.templateOptions = options.templateOptions || {};

	ShipmentForButList_View.superclass.constructor.call(this,id,options);

	var model = (options.models&&options.models.ShipmentForButList_Model)? 
		options.models.ShipmentForButList_Model: new ShipmentForButList_Model();
	...
	this.addElement(new GridAjx(id+":grid",{
		...
		"controller":contr,
		"keyIds":["id"],
		"readPublicMethod":contr.getPublicMethod("get_for_buh_shipment_list"),
		"editInline":false,
		"editWinClass":null,
		"commands": null,
		"popUpMenu":null,
		"filters":(options.detailFilters&&options.detailFilters.ShipmentForButList_Model)? 
			options.detailFilters.ShipmentForButList_Model : null,
...
extend(ShipmentForButList_View, ViewAjxList);
