 ...
 */	
function VehicleTotRepCommonItemDialog_View(id,options){	
	...
	VehicleTotRepCommonItemDialog_View.superclass.constructor.call(this,id,options);
...
extend(VehicleTotRepCommonItemDialog_View, ViewObjectAjx);
