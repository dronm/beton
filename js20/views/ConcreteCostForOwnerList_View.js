 ...
 */
function ConcreteCostForOwnerList_View(id,options){	

	options = options || {};
	ConcreteCostForOwnerList_View.superclass.constructor.call(this,id,options);

	var model = (options.models&&options.models.ConcreteCostForOwnerList_Model)? options.models.ConcreteCostForOwnerList_Model : new ConcreteCostForOwnerList_Model();
	var contr = new ConcreteCostForOwner_Controller();
	...
	this.addElement(new GridAjx(id+":grid",{
		...
		"filters":options.detailFilters? options.detailFilters.ConcreteCostForOwnerList_Model:null,
