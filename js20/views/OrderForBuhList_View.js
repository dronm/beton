 ...
 */
function OrderForBuhList_View(id,options){	

	options.templateOptions = options.templateOptions || {};
	options.templateOptions.HEAD_TITLE = "Форирование накладных 1с";

	options.addElement = function(){
		const self = this;
		
		var model = new OrderForBuhList_Model();
							...
							,new GridCellHead(id+":grid:head:ship_date",{
								...
								"columns":[
									new GridColumnDate({
										...
										"master":true,
										"detailViewClass":ShipmentForBuhList_View,
										"detailViewOptions":{
											"detailFilters":{
												"ShipmentForBuhList_Model":[
													{
													"masterFieldId":"id",
													"field":"order_id",
													"sign":"e",
	...
	OrderForBuhList_View.superclass.constructor.call(this,id,options);
}
extend(OrderForBuhList_View, ViewAjxList);

OrderForBuhList_View.prototype.setGridFilter = function(dFrom,dTo){
