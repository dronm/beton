BEGIN;
	...
	drop FUNCTION if EXISTS const_water_val();
	drop FUNCTION if EXISTS const_water_set_val();
	...
	drop VIEW if EXISTS const_water_view;

	drop TABLE if EXISTS const_water;
