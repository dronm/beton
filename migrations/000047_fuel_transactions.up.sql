begin;
	...
	(id text NOT NULL,date_time timestamp NOT NULL,card_id text NOT NULL,vehicle_id int NOT NULL,attrs json,quant int
			DEFAULT 0,total  numeric(15,2)
			DEFAULT 0,CONSTRAINT fuel_transactions_pkey PRIMARY KEY (id,vehicle_id)
	);
