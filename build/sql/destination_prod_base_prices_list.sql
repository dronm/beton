-- VIEW: destination_prod_base_prices_list

DROP VIEW destination_prod_base_prices_list;

CREATE OR REPLACE VIEW destination_prod_base_prices_list AS
	SELECT
		t.id
		,t.destination_id
...
ALTER VIEW destination_prod_base_prices_list OWNER TO ;
