-- Function: public.available_spots_for_order_dif_speed(date, numeric, numeric)

-- DROP FUNCTION public.available_spots_for_order_dif_speed(date, numeric, numeric);

CREATE OR REPLACE FUNCTION public.available_spots_for_order_dif_speed(
    IN in_date date,
    IN in_quant numeric,
...
BEGIN
	...
	speed_tolerance = round(in_speed_per_hour * const_speed_change_for_order_autolocate_val() /100::numeric);
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.available_spots_for_order_dif_speed(date, numeric, numeric)
  OWNER TO beton;
